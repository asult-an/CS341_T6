...
namespace CookNook.Model
{
    ...
    //public class IngredientAutcompleteStrategy : IAutocompleteStrategy<Ingredient>
    //{
    //    public Task<IEnumerable<string>> GetSuggestionsAsync(string input, IEnumerable<Ingredient> collection)
    //    {
